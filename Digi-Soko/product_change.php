 ...
 */
 ...
 $link = mysqli_connect('localhost', 'root','','vegetables_website' );
...
<div class="row" style="background-color:aliceblue;">
  ...
  <div class="column">
  <?php echo "<img src='list/".$row['Image']."' >";?>
            ...
            <?php echo "<a class='btn btn-primary' href='update.php?product=".$row["Product_id"]."'>Update</a>"?>
            <?php echo "<a class='btn btn-danger' href='delete.php?product=".$row["Product_id"]."'>Delete</a>"?>
            <br>
        <br>
  </div>
        <?php } ?>
